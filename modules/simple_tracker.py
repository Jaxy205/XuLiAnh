...
class CentroidTracker:
    def __init__(self, max_disappeared=50, max_distance=50):
        ...
        # Dictionary lưu trữ: ID -> List của centroids (Quỹ đạo)
        self.trajectories = OrderedDict()
        
        # Số point tối đa trong quỹ đạo (để tránh tràn bộ nhớ)
        self.max_trace_length = 30  # Lưu 30 vị trí gần nhất
    ...
    def update(self, rects):
        ...
        # Nếu đang theo dõi, cần ghép cặp centroid cũ và mới
            ...
            for (row, col) in zip(rows, cols):
                ...
                if len(self.trajectories[object_id]) > self.max_trace_length:
